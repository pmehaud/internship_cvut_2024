...
MEAN_DISTANCE_PARAMS = {
    ...
    ']1, 2] km': {'colour': '#069AF3', 'min_angle': 15, 'max_distance': 5},
    ']2, 4] km': {'colour': '#02D4BB', 'min_angle': 25, 'max_distance': 10},
    ']4, inf] km': {'colour': '#0DBF75', 'min_angle': 30, 'max_distance': 15},
}

# Parameters for simple criteria
MAX_DISTANCE = 15
MIN_ANGLE = 20
